              ...
              >
                ...
                {hasAccess('schedule', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Schedule"
                    text={
                      <Link as={NextLink} href={`/schedules/view/${data?.schedule?.id}`}>
                        {data?.schedule?.match_date}
                      </Link>
                    }
                  />
                )}
                {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="User Match Opponent Id Touser"
                    text={
                      <Link as={NextLink} href={`/users/view/${data?.user_match_opponent_idTouser?.id}`}>
                        {data?.user_match_opponent_idTouser?.email}
                      </Link>
                    }
                  />
                )}
