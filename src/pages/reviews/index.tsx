...
export function ReviewListPage(props: ReviewListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getReviews({
        relations: ['user_review_user_idTouser', 'user_review_reviewer_idTouser'],
  ...
  const columns: ColumnType[] = [
    { id: 'fair_play', header: 'fair_play', accessorKey: 'fair_play' },
    { id: 'playability', header: 'playability', accessorKey: 'playability' },
    { id: 'punctuality', header: 'punctuality', accessorKey: 'punctuality' },
