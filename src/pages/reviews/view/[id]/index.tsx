        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Fair Play" text={data?.fair_play} />

                <FormListItem label="Playability" text={data?.playability} />

                <FormListItem label="Punctuality" text={data?.punctuality} />
