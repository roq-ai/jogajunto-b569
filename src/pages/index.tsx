...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`JogaJunto`}</title>

        <meta
          name="description"
          content="Experience JogaJunto - your interactive platform for scheduling football matches, connecting with other players, and discovering local courts. Elevate your game with our unique ranking system based on fair play, playability, punctuality, and availability."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmb290YmFsbHxlbnwwfHx8fDE2OTQwMTg2Nzd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience JogaJunto - your interactive platform for scheduling football matches, connecting with other players, and discovering local courts. Elevate your game with our unique ranking system based on fair play, playability, punctuality, and availability.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Platform Administrator"
