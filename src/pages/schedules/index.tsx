...
export function ScheduleListPage(props: ScheduleListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getSchedules({
        relations: ['user', 'organization', 'match.count'],
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.match_date ? format(parseISO(record?.match_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'match_time',
      header: 'Match Time',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.match_time ? format(parseISO(record?.match_time as unknown as string), 'dd-MM-yyyy') : '',
    },
