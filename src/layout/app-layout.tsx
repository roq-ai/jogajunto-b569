...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['platform-administrator', 'player'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Courts', path: '/courts', entity: 'court', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Matches', path: '/matches', entity: 'match', service: AccessServiceEnum.PROJECT, icon: FiPlayCircle },
